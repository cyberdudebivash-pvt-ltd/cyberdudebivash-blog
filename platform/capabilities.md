...
| Knowledge Graph | Normalized docs | Entity/relation graph | `knowledge_graph.py` (offline) **and, separately,** `api/_lib/threat-graph.js` (live) | None cross-checking the two | **Duplicated — see `open-issues.md`** | Unassigned |
