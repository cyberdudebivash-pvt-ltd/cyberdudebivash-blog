...
| Field | Value |
|---|---|
| `origin/main` HEAD | `acc8d30ea` (verified 2026-08-20T18:42Z) — PR #116 merged this round; auto-syndication commits land on `main` frequently and are unrelated content |
| Open PRs from this round | **PR #117** (`reportx/phase1i-structured-attack`) — structured ATT&CK object. Open, CodeRabbit review received (9 findings — 1 real code defect, 8 doc-accuracy items), being addressed now. #108–#116 all merged. |
| Working tree | Clean (branch `reportx/phase1i-structured-attack`, committed and pushed as PR #117) |
