...
| Billing / payments | Redis (Upstash), confirmed to mirror Stripe/Razorpay/human-admin-owned truth, never itself the ledger | **Not migrated** — audited this round with real evidence, deliberately deferred | same, §B |
